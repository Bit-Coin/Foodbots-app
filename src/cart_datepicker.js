                ...
                <div className="box_style_2" id="order_process">
                  ...
                  <div className="row">
                    <div className="col-md-12">
                        ...
                        <textarea className="form-control cart_dateheight"   placeholder="Ex. Allergies, cash change..." name="notes" id="notes " style={cart_dateheight} ></textarea>
              ...
              <div className="col-md-3" id="sidebar">
                <div className="theiaStickySidebar">
                  <div id="cart_box">
                    ...
                    <hr/>
                    <a className="btn_full" href="cart_2.html">Go to checkout</a>
