...
import pup_up_img from './img/popup_img.jpg';
...
export default class index5  extends Component {
   ...
   componentDidMount() {
        new window.$.popup({                
            title       : '',
            content         : '<a href="all_tours_list.html"><img src={pup_up_img} alt="" class="pop_img"><h3 id="pop_msg">This week special offer <strong>Free Delivery</strong> on all Menu & Orders!</h3></a><small>Autoclose delay in 5 seconds.</small>', 
            html: true,
            autoclose   : true,
            closeOverlay:true,
            closeEsc: true,
