        ...
        <div id="position">
            <div className="container">
                <ul>
                    ...
                    <li><Link to="#0">Category</Link></li>
                    <li>Page active</li>
                </ul>
                 <Link to="#0" className="search-overlay-menu-btn">
                  <i className="icon-search-6"></i> Search</Link>
            </div>
        </div>
      ...
      <div className="container margin_60_35">
        <div className="row">      
          <div className="col-md-3">
            <p>
              <Link className="btn_map" data-toggle="collapse" to="#collapseMap" aria-expanded="false" aria-controls="collapseMap">View on map</Link>
            </p>
            <div id="filters_col">
              <Link data-toggle="collapse" to="#collapseFilters" aria-expanded="false" aria-controls="collapseFilters" id="filters_col_bt">Filters <i className="icon-plus-1 pull-right"></i>
              </Link>
          ...
          <div className="col-md-9">          
              ...
              <div className="row">
                ...
                <div className="col-md-9 col-sm-9 hidden-xs">
                  <Link to="grid_list.html" className="bt_filters"><i className="icon-th"></i></Link>
                </div>
              </div>
            </div>          
            <div className="strip_list wow fadeIn" data-wow-delay="0.1s">
              ...
              <div className="row">
                <div className="col-md-9 col-sm-9">
                  <div className="desc">
                    <div className="thumb_strip">
                      <Link to="detail_page.html">
                        <Image src={thumb_restaurant} alt=""/></Link>
                    </div>
                    <div className="rating">
                      ...
                      <i className="icon_star voted"></i>
                      <i className="icon_star"></i> 
                      (<small><Link to="#0">98 reviews</Link></small>)
                    </div>
                    <h3>Taco Mexican</h3>
                    <div className="type">
                      Mexican / American
                ...
                <div className="col-md-3 col-sm-3">
                  <div className="go_to">
                    <div>
                      <Link to="detail_page.html" className="btn_1">View Menu</Link>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="strip_list wow fadeIn" data-wow-delay="0.2s">
              <div className="ribbon_1">
                Popular
              </div>
              <div className="row">
                <div className="col-md-9 col-sm-9">
                  <div className="desc">
                    <div className="thumb_strip">
                      <Link to="detail_page.html">
                        <Image src={thumb_restaurant_2} alt=""/></Link>
                    </div>
                    <div className="rating">
                      <i className="icon_star voted"></i>
                      <i className="icon_star voted"></i>
            ...
            <div className="strip_list wow fadeIn" data-wow-delay="0.3s">
              <div className="row">
                <div className="col-md-9 col-sm-9">
                  <div className="desc">
                    <div className="thumb_strip">
                      <Link to="detail_page.html">
                        <Image src={thumb_restaurant_3} alt=""/></Link>
                    </div>
                    <div className="rating">
                      <i className="icon_star voted"></i>
                      <i className="icon_star voted"></i>
            ...
            <div className="strip_list wow fadeIn" data-wow-delay="0.4s">
              <div className="row">
                <div className="col-md-9 col-sm-9">
                  <div className="desc">
                    <div className="thumb_strip">
            ...
            <div className="strip_list wow fadeIn" data-wow-delay="0.5s">
              <div className="row">
                <div className="col-md-9 col-sm-9">
                  <div className="desc">
                    <div className="thumb_strip">
                      <Link to="detail_page.html"><Image src={thumb_restaurant_5} alt=""/></Link>
                    </div>
                    <div className="rating">
                      <i className="icon_star voted"></i>
                      <i className="icon_star voted"></i>
            ...
            <div className="strip_list last wow fadeIn" data-wow-delay="0.6s">
              <div className="row">
                <div className="col-md-9 col-sm-9">
                  <div className="desc">
                    <div className="thumb_strip">
                      <Link to="detail_page.html"><Image src={thumb_restaurant_6} alt=""/></Link>
                    </div>
                    <div className="rating">
                      <i className="icon_star voted"></i>
                      <i className="icon_star voted"></i>
                ...
                <div className="col-md-3 col-sm-3">
                  ...
                  <Link to="#0" className="load_more_bt wow fadeIn" data-wow-delay="0.2s">Load more...</Link>  
          </div>
