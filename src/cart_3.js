          ...
          <div className="row">
            <div className="col-md-offset-3 col-md-6">
              <div className="box_style_2">
                ...
                <tr>
                  <td>
                     Delivery schedule <a href="#" className="tooltip-1" data-placement="top" title="" data-original-title="Please consider 30 minutes of margin for the delivery!"><i className="icon_question_alt"></i></a>
                  </td>
                  <td>
                    <strong className="pull-right">Today 07.30 pm</strong>
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="total_confirm">
                    <span className="pull-right">$66</span>
                  </td>
                </tr>
                </tbody>
                </table>
